                            ...
                            {paginatedStores.map((store) => (
                                <div key={store.id} className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
                                    <div className="flex justify-between items-start mb-3">
                                        ...
                                        <button
                                            onClick={() => handleToggleActive(store)}
                                            className={`px-2.5 py-1 rounded-full text-xs font-medium ${store.isActive
                                    ...
                                    <div className="flex items-center gap-2 mb-4 p-2 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                        ...
                                        <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400">Quản lý</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-white">{getManagerName(store.managerId)}</p>
                                        </div>
                                    </div>
