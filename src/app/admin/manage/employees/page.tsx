...
export default function AdminEmployeesPage() {
        ...
        return (
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Xem và quản lý nhân viên cửa hàng</p>
                </div>
                <StoreSelector />
                <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl p-8 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Vui lòng chọn cửa hàng để xem danh sách nhân viên</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            ...
            {/* Add/Edit Modal - Same as Manager */}
