...
import { Users, Plus, Edit, Trash2, Search, ChevronLeft, ChevronRight, X, ChevronDown } from 'lucide-react';
...
export default function AdminUsersPage() {
    ...
    const handleRoleFilterChange = (value: 'all' | 'manager' | 'employee') => {
        setRoleFilter(value);
        setCurrentPage(1);
    };
    ...
    return (
        <div>
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Quản lý người dùng</h1>
                <p className="text-gray-600 dark:text-gray-400">Thêm, sửa, xóa manager và nhân viên</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <select
                    ...
                    className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none dark:text-white"
                >
                        ...
                        <div className="hidden md:block overflow-x-auto">
                            <table className="w-full">
                                <thead className="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
                                    <tr>
                                        <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-300 font-medium">Họ và tên</th>
                                        <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-300 font-medium">Email</th>
                                        <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-300 font-medium">Vai trò</th>
                                ...
                                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                    {paginatedUsers.map((user) => (
                                        <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                            <td className="py-3 px-4 font-medium text-gray-900 dark:text-white">{user.displayName}</td>
                                            ...
                                            <td className="py-3 px-4">
                                                <span className={`px-3 py-1 rounded-full text-xs font-medium ${user.role === 'manager'
                                                    ...
                                                    {user.role === 'employee' && user.employeeType && ` (${getEmployeeTypeLabel(user.employeeType)})`}
                                                </span>
                                            </td>
                                            <td className="py-3 px-4 text-gray-600 dark:text-gray-400">{getStoreName(user.storeId)}</td>
                                ...
                                <div key={user.id} className="p-4 bg-white dark:bg-gray-800">
                                    <div className="flex justify-between items-start mb-3">
                                        <div className="flex items-center gap-3">
                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold shadow-md ${user.role === 'manager' ? 'bg-gradient-to-br from-purple-500 to-indigo-600' : 'bg-gradient-to-br from-blue-500 to-cyan-500'
                                                }`}>
                                        ...
                                        <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${user.role === 'manager'
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mb-4 text-sm">
                                        <div className="bg-gray-50 dark:bg-gray-700/30 p-2 rounded-lg">
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Cửa hàng</p>
                                            <p className="font-medium text-gray-900 dark:text-white truncate">
                                                {getStoreName(user.storeId)}
                                            </p>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-700/30 p-2 rounded-lg">
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Loại NV</p>
                                    ...
                                    <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
                                        <div className="text-sm">
                                            <span className="text-gray-500 dark:text-gray-400">Lương: </span>
                                            <span className="font-semibold text-green-600 dark:text-green-400">
                                                {user.hourlyRate ? `${user.hourlyRate.toLocaleString('vi-VN')}đ/h` : '-'}
                                            </span>
                                        </div>
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/80">
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className="p-2 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-white dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all text-gray-700 dark:text-gray-300"
                                    >
                            ...
                            <div className="p-6 space-y-5 overflow-y-auto max-h-[calc(90vh-240px)]">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className={!editingUser ? "md:col-span-2" : "md:col-span-2"}>
                                            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
