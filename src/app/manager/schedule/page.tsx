...
export default function ManagerSchedulePage() {
    ...
    const handleJumpToNextWeek = () => {
        setCurrentWeek(addWeeks(new Date(), 1));
    };
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Xem và quản lý lịch làm việc của nhân viên</p>
            </div>
            ...
            {/* Desktop Calendar Grid (Rows: Morning, Afternoon, Night) */}
