        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    {comparison && (
                        <div className={`flex items-center gap-1 text-sm ${comparison.salaryChange >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                            }`}>
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                            {currentPayroll.employees.map((emp, index) => (
                                <tr key={emp.employeeId} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">{emp.completedShifts}</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">{emp.totalHours}h</td>
                                    <td className="py-4 px-6 text-right text-purple-600 dark:text-purple-400 font-medium">
