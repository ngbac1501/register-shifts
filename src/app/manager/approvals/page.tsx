                            ...
                            <>
                                ...
                                <div className="lg:hidden p-4 space-y-4">
                                    {filteredSchedules.map((schedule) => {
                                        ...
                                        return (
                                            <div key={schedule.id} className="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border ${schedule.status === 'approved' ? 'bg-green-100 text-green-700 border-green-200 dark:bg-green-900/20 dark:text-green-400 dark:border-green-800' :
                                                                schedule.status === 'pending' ? 'bg-yellow-100 text-yellow-700 border-yellow-200 dark:bg-yellow-900/20 dark:text-yellow-400 dark:border-yellow-800' :
                                                                    schedule.status === 'rejected' ? 'bg-red-100 text-red-700 border-red-200 dark:bg-red-900/20 dark:text-red-400 dark:border-red-800' :
                                                                        'bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-900/20 dark:text-purple-400 dark:border-purple-800'
                                                                }`}>
                                                    ...
                                                    <div className="text-right">
                                                        <p className="text-sm font-bold text-gray-900 dark:text-white">{formatDate(schedule.date, 'dd/MM/yyyy')}</p>
                                                ...
                                                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 flex justify-between items-center">
                                                    <div>
                                                        <p className="text-xs text-gray-500 dark:text-gray-400">Ca làm việc</p>
                                                        <p className="font-semibold text-gray-900 dark:text-white">{shift.name}</p>
                                                    </div>
                                                    <div className="text-right">
                                                        <p className="text-xs text-gray-500 dark:text-gray-400">Giờ làm</p>
                                                        <p className="font-semibold text-gray-900 dark:text-white">{shift.time}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex items-center justify-end gap-2 pt-2">
                                                    {isPending && (
                                                        <>
                                                            <button
                                                                onClick={() => handleApprove(schedule.id)}
                                                                className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-green-600 text-white rounded-xl font-medium shadow-md shadow-green-500/20"
                                                            >
                                                                <Check className="w-4 h-4" /> Duyệt
                                                            </button>
                                                            <button
                                                                onClick={() => handleRejectClick(schedule)}
                                                                className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-orange-500 text-white rounded-xl font-medium shadow-md shadow-orange-500/20"
                                                            >
                                                    ...
                                                    {isApproved && (
                                                        <button
                                                            onClick={() => handleComplete(schedule.id)}
                                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-purple-600 text-white rounded-xl font-medium shadow-md shadow-purple-500/20"
                                                        >
                                                    ...
                                                    {isRejected && (
                                                        <button
                                                            onClick={() => handleDeleteClick(schedule)}
                                                            className="p-2.5 bg-red-100 text-red-600 rounded-xl"
                                                        >
                                                            <Trash2 className="w-5 h-5" />
                                                        </button>
                                                    )}
                                                    ...
                                                    <button
                                                        onClick={() => handleEdit(schedule)}
                                                        className="p-2.5 bg-blue-100 text-blue-600 rounded-xl"
                                                    >
                                                        <Edit className="w-5 h-5" />
                                                    </button>
                                                </div>
                            ...
                            <>
                                ...
                                <div className="lg:hidden p-4 space-y-4">
                                    {filteredSwaps.map((swap) => {
                                        ...
                                        return (
                                            <div key={swap.id} className="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex flex-col gap-2">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-sm font-bold text-gray-900 dark:text-white truncate max-w-[100px]">{fromEmployee.name}</span>
                                                            ...
                                                            {toEmployee ? (
                                                                <>
                                                                    ...
                                                                    <span className="text-sm font-bold text-gray-900 dark:text-white truncate max-w-[100px]">{toEmployee.name}</span>
                                                                </>
                                                            ) : (
                                                                <span className="text-xs text-gray-400 italic">Công khai</span>
                                                            )}
                                                        </div>
                                                        <span className={`inline-flex items-center w-fit px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border ${swap.status === 'approved' ? 'bg-green-100 text-green-700 border-green-200 dark:bg-green-900/20 dark:text-green-400 dark:border-green-800' :
                                                            swap.status === 'pending' ? 'bg-yellow-100 text-yellow-700 border-yellow-200 dark:bg-yellow-900/20 dark:text-yellow-400 dark:border-yellow-800' :
                                                                'bg-red-100 text-red-700 border-red-200 dark:bg-red-900/20 dark:text-red-400 dark:border-red-800'
                                                            }`}>
                                                            {getStatusLabel(swap.status)}
                                                ...
                                                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 flex justify-between items-center">
                                                    <div>
                                                        <p className="text-xs text-blue-600 dark:text-blue-400">Ca cần đổi</p>
                                                        <p className="font-semibold text-gray-900 dark:text-white">{shift.shiftName}</p>
                                                    </div>
                                                    <div className="text-right">
                                                        <p className="text-xs text-blue-600 dark:text-blue-400">Ngày</p>
                                                        <p className="font-semibold text-gray-900 dark:text-white">{formatDate(swapDate, 'dd/MM/yyyy')}</p>
                                                    </div>
                                                </div>
                                                ...
                                                {isPending && swap.toEmployeeId && (
                                                    <div className="flex items-center gap-2 pt-2">
                                                        <button
                                                            ...
                                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-green-600 text-white rounded-xl font-medium shadow-md shadow-green-500/20"
                                                        >
                                                            <Check className="w-4 h-4" /> Duyệt đổi
                                                        </button>
                                                        <button
                                                            onClick={() => openRejectSwapModal(swap)}
                                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-red-500 text-white rounded-xl font-medium shadow-md shadow-red-500/20"
                                                        >
                                                            <X className="w-4 h-4" /> Từ chối
                                                        </button>
                                                    </div>
